...
data Publication_Timeline;
	...
	if LastSubmitted<0 then LastSubmitted=.;
	...
	if (PT_Support_Govt_NonPHS^=' ' or PT_Support_Govt_PHS^=' '
		or PT_Support_NIH_Extra^=' ' or PT_Support_NIH_Intra^=' ') then Govt_NIH_Support="Govt or NIH Support";
		else Govt_NIH_Support='No Support';
